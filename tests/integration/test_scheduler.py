...
pytestmark = pytest.mark.skipif(
    scheduler is None,
    reason="Scheduler module not available"
)
...
@pytest.mark.skipif(not hasattr(scheduler, 'start_scheduler'), reason="Autom8 scheduler not available")
...
@pytest.mark.parametrize("trigger_type,trigger_args", [
    ('interval', {'seconds': 60}),
    ('interval', {'minutes': 1}),
    ('interval', {'hours': 1}),
