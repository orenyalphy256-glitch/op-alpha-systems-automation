...
from autom8.core import (
    load_json, save_json, JSONFormatter, ContextLogger, setup_logging
)
from autom8.metrics import (
    get_system_metrics, get_task_metrics, get_database_metrics, get_all_metrics
)
from autom8.alerts import (
    send_email_alert, alert_task_failure, alert_system_issue
)
...
def test_send_email_alert(mock_smtp):
    with patch("autom8.alerts.SMTP_USERNAME", "user"), \
         patch("autom8.alerts.SMTP_PASSWORD", "pass"):
